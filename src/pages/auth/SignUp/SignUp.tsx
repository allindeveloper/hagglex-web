...
const SignUp: React.FC<any> = () => {
 ...
 <CustomInput 
                                    ...
                                    name="phonenumber"
                                    handleChange={(e) => handleCreateFormInputChange("phonenumber", "Phone number", e)}
                                    type="text" labelText="Enter your phone number" id="signup-phonenumber" placeholder="Enter your mobile number" />
